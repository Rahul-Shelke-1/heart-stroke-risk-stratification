...
class BalancedBaggingClassifierCustom(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, y):
        # SFS passes a small subset of features here as a NumPy array
        ...
        base_clf = self.base_estimator if self.base_estimator else DecisionTreeClassifier()
